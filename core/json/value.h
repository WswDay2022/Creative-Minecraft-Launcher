...
// Disable warning C4251: <data member>: <_type> needs to have dll-interface to
// be used by...
 ...
 *
 * The _type of the held value is represented by a #ValueType and
 * can be obtained using _type().
 *
...
public:
  /**
   * \brief Create a default Value of the given _type.
   *
  ...
  /// \pre _type() is arrayValue, objectValue, or nullValue
  /// \post _type() is unchanged
  void clear();

  /// Resize the array to newSize elements.
  /// New elements are initialized to null.
  /// May only be called on nullValue or arrayValue.
  /// \pre _type() is arrayValue or nullValue
  /// \post _type() is arrayValue
  ...
  /// \pre _type() is objectValue or nullValue
  /// \post _type() is unchanged
  ...
  /// \pre _type() is objectValue or nullValue
  /// \post if _type() was nullValue, it remains nullValue
...
/// These `as` specializations are _type conversions, and do not have a
/// corresponding `is`.
